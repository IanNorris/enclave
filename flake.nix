{
  ...
  outputs = { self, nixpkgs, flake-utils }:
    flake-utils.lib.eachDefaultSystem (system:
      ...
      # NixOS module (placeholder for future system-level integration)
      nixosModules.default = { config, lib, pkgs, ... }:
        ...
        in {
          ...
          config = lib.mkIf cfg.enable {
            # The orchestrator runs as a user service (systemd --user).
            # This module is reserved for future system-level integration.
          };
        };
    };
}
