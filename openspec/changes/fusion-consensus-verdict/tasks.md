...
- [ ] 1.5 Judge + synthesizer: order findings by priority/severity, not by origin (agreement-bucket or response order) — review feedback
- [ ] 1.6 No external citation/statistic baked into the prompt text
- [ ] 1.7 Unit test: rendered judge prompt contains "Verdict" and no "high-confidence"; synthesizer no longer instructs leading with consensus
