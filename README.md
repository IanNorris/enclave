...
- **[OpenSpec](https://github.com/Fission-AI/OpenSpec)** — spec-driven development workflow (MIT, vendored as a submodule under `third_party/openspec`); specs live in `openspec/` and are reviewable in the web UI's **Specs** tab. Generated/derived files are credited in [`THIRD_PARTY_NOTICES.md`](THIRD_PARTY_NOTICES.md)
